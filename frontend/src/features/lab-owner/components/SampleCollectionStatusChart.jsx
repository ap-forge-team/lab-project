...
const SampleCollectionStatusChart = ({ data, filter, onFilterChange }) => {
  ...
  return (
    <div className="bg-white rounded-xl border border-border shadow-sm p-4 sm:p-5">
      <div className="flex items-center justify-between mb-4 gap-2">
        <h3 className="font-serif text-base sm:text-lg font-bold text-foreground">Sample Collection Status</h3>
...
export default SampleCollectionStatusChart
